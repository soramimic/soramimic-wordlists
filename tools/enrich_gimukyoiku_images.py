...
MANUAL_TITLES = {
    ...
    "スメタナ": ("ja", "ベドルジハ・スメタナ"),
    "スーホの白い馬": ("ja", "モリンホール"),
    "トルコ行進曲": ("ja", "ヴォルフガング・アマデウス・モーツァルト"),
    "トロッコ": ("ja", "芥川龍之介"),
    "パレット": ("ja", "パレット (絵画)"),
    "ビー玉転がし": ("ja", "ビー玉"),
    "プラタナスの木": ("ja", "スズカケノキ"),
