...
EXCLUDED = {
    ...
    # 哲学・思想・文学のみで著名で、数学・自然科学の具体的業績が確認できない人物
    "王充",  # 後漢の文人・思想家。『論衡』は思想書で数学・天文学の業績なし
    "エリアス・カネッティ",  # ノーベル文学賞作家で化学研究実績なし
    "オスヴァルト・シュペングラー",  # 文化哲学者・歴史学者で数学研究実績なし
    "アラン・バディウ",  # 哲学者で数学研究実績なし
    "トマス・アプト",  # 通俗哲学者で数学研究実績なし
    "トマス・ホッブズ",  # 政治哲学者で独立して評価される数学業績なし
    "ルートヴィヒ・ウィトゲンシュタイン",  # 哲学者で数学研究実績なし
    "アレクシウス・マイノング",  # 哲学者・心理学者で数学研究実績なし
    "カール・ポパー",  # 科学哲学者で数学研究実績なし
    "イェフダ・レーヴ・ベン・ベザレル",  # ラビ・神秘思想家で数学研究実績なし
    "パタンジャリ",  # 曖昧な人名記事で数学者を特定できない
    "カジミェシュ・トヴァルドフスキ",  # 哲学者で数学研究実績なし
    "エレナ・コルナロ・ピスコピア",  # 哲学博士として著名で数学研究実績なし
    "マックス・ブラック",  # 言語哲学者で数学研究実績なし
    "フィリップ・メランヒトン",  # 神学者・宗教改革者で天文学研究実績なし
    "アンモニオス・ヘルメイウ",  # ネオプラトニズム哲学者で天文学研究実績なし
    "ヘルムート・プレスナー",  # 哲学者・社会学者で生物学研究実績なし
