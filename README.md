...
| vtuber.csv | VTuber（`scope`で日本向け/海外中心/未判定を選択可） | Wikidata、Wikipedia、公式プロフィール、[YouTube Data API v3](https://developers.google.com/youtube/v3)、Wikimedia Commons、[あおぎり高校](https://vhs-city.com/aogirihighschool/)、[ななしいんく](https://www.774.ai/) |
