...
| description | stations固有: 日本語版Wikipediaの記事冒頭から作った、所在地・路線・特徴を紹介する短い完結文。記事が無ければWikidataの日本語説明、どちらも無ければ空。既存値を上書きせず、空欄だけを `tools/enrich_station_descriptions.py` で補完する |
